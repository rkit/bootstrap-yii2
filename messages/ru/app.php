...
return [
    ...
    'Max. file size' => 'Мак. размер файла',
    'Max. height' => 'Мак. высота',
    'Max. size if image' => 'Мак. размер картинки',
    'Max. width' => 'Мак. ширина',
    'Mime' => 'Тип файла',
    ...
    'This role has all privileges by default, it can not be edited' => 'Эта роль имеет все привилегии по умолчанию, она не может быть изменена',
